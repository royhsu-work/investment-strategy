...
Trace: proposal result-vs-handoff contract → specs `Required routing handoff completes only after durable routing transition and HANDOFF evidence` plus lifecycle-journal requirement → implementation slice 9.
