...
- [ ] 5.1 RED: add contract/regression coverage proving material workflow lifecycle transitions require one bounded persistent-coordination-Issue journal record while ordinary RED/GREEN/refactor/test-trigger/compatibility-correction commits and artifact/task edits inside an unverified implementation slice do not; cover interrupted lifecycle-journal recovery without repeating the completed transition.
