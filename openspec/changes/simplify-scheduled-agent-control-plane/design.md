...
This Design was authored from a fresh read of the default-branch governance at main@e8c3dc7b256bc167217e25a397e98181bdf6f123 and the pre-correction PR #178 state. At the start of this correction, repository-owned dispatch had selected #138 as agent:lead + action:resolve-question; that pre-correction routing tuple is historical input and is not a current-state claim. Current main@e8c3dc7b256bc167217e25a397e98181bdf6f123 still carries the older role-label and continuation model, while PR #178 pre-reset head 5592ee855406c065c54c137832a85f532f617898 contained the prior incremental plan. PR #178 input head e522480b00178378876967ab5156c6fdc2671c3a is the historical pre-correction revision observed for that Lead invocation. The resulting exact target R is the revision emitted by the Lead ACTION_RESULT and fresh PR/ref observation, with its exact-R validation resource bound to that same R. Human intent issuecomment-5528834334 explicitly supersedes the prior plan and requires a first-principles reset.
