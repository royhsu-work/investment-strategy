...
#### Scenario: Executable precondition rejects the #100/#130 recurrence shape

- GIVEN the complete executable precondition input contains #100 as a formal active workflow
- AND #130 is an open routed `Lead / explore-change + Change: unset` pre-activation candidate
- WHEN runtime evaluates whether #130 may begin substantive Explore
- THEN the production executable decision selects the formal workflow rather than #130
...
#### Scenario: Propose action result preserves pre-write and post-write activation evidence
